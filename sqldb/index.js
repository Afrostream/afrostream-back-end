...
db.Carousel = db.sequelize.import('models/carousel');
db.CarouselItem = db.sequelize.import('models/carouselItem');
db.CarouselItems = db.sequelize.import('models/carouselItems');
...
db.Carousel.belongsToMany(db.CarouselItem, {through: db.CarouselItems, as: 'slides', foreignKey: 'carouselItemId'});
db.CarouselItem.belongsTo(db.Carousel, {through: db.CarouselItems, as: 'carousel', foreignKey: 'carouselId'});
db.CarouselItem.belongsTo(db.Image, {as: 'poster', constraints: false});
db.CarouselItem.belongsTo(db.Image, {as: 'logo', constraints: false});
//JOIN

...
program
  ...
  .option('-e, --env [env]', 'env: localhost, cdnOrangeStaging, staging, prodOrigin, prodBoxOrigin, prodBouyguesMiami, prodOrange, prodLegacyApi; default=staging')
  .option('-u, --username [username]', 'username, default=tech@afrostream.tv')
  .option('-p, --password [password]', 'password')
  .option('-r, --request [request]', 'path to request')
  .parse(process.argv);

var username = program.username || 'marc.dassonneville@gmail.com';
...
var clientsConf = {
  tapptic: {
    id: "1abf31b2-8269-442f-9fd2-f3a63bda64b4",
    secret: "ba287044-65cf-4c30-a6f7-51aed34d4791"
  },
  front: {
    id: "8c261045-89a3-44bb-af38-65a847269605",
    secret: "3dc3cae6-9c79-487a-9e0f-712be857dcee"
  },
  "bouygues-miami": {
    id: "cbd89e11-c8a2-45ab-93be-deaade1bd17f",
    secret: "6bb9d594-9b4c-489b-ab04-d76dda10c76a"
  },
  "orange-newbox": {
    id: "66355a25-99bb-422a-a01f-5ce5b37c9f77",
    secret: "66e732ac-2d8f-4c3e-bd8b-cfde890bcde6"
  }
};
...
var envsConf = {
  ...
  prodBoxOrigin: {
    baseUrl: "https://afrostream-backend-box.herokuapp.com"
  },
  prodLegacyApi: {

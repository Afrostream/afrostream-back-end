...
module.exports = {
  ...
  pf: {
    timeout: 10000,
    url: process.env.AFROSTREAM_PF_BASE_URL || 'http://p-afsmsch-001.afrostream.tv:4000'
  },
  ...
  mailblast: {
    token: process.env.MAILBLAST_TOKEN || 'y5MS3F4vq9X-g7o328vrZHszYxueSA',
  ...
  netsize: {
    ...
    "initialize-subscription-success-code-list": [ "111", "420", "421", "424" ],
